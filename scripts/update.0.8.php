<?php
if($kfm_parameters['version']=='7.0'||$kfm_parameters['version']<'0.7.2')require 'scripts/update.0.7.2.php';
switch($kfm_db_type){
	case 'mysql':{
...
$db->query("update ".$kfm_db_prefix."parameters set value='0.8' where name='version'");
?>
