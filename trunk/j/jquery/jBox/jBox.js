...
*/
var jBox_dir='jquery/jBox/images/';
var jBox={
    imgs:[jBox_dir+'min.gif', jBox_dir+'close.gif', jBox_dir+'restore.gif',jBox_dir+'resize.gif'],
	...
	load:function(box,type,source,title,ajaxOpt){
	    ...
	    if (type=="inline"){
		     ...
		     var boxel=document.getElementById(source);
		     $(boxel).show();
		     box.content.append(boxel);
	    }else if (type=="iframe"){
