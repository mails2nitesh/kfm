...
function kfm_showTextFile(res){
	...
	kfm.addCell(r2,c++,1,newLink('javascript:if($("edit-start").value==codepress.getCode() || kfm.confirm( kfm.lang.CloseWithoutSavingQuestion)){if($("kfm_left_column_hider"))$("kfm_left_column_hider").remove();kfm_changeDirectory("kfm_directory_icon_"+kfm_cwd_id);}',kfm.lang.Close,0,'button'));
